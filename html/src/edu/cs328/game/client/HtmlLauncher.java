...
import edu.cs328.game.DungeonMan;
...
public class HtmlLauncher extends GwtApplication {
    ...
    native void setupResizeHook() /*-{
        var htmlLauncher_onWindowResize = $entry(@edu.cs328.game.client.HtmlLauncher::handleResize());
